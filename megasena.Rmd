...
dez1 <- dez1 %>% mutate(value = as.numeric(value)) %>% drop_na()

dez2 <- dez2 %>% mutate(value = as.numeric(value)) %>% drop_na()

dez3 <- dez3 %>% mutate(value = as.numeric(value)) %>% drop_na()

dez4 <- dez4 %>% mutate(value = as.numeric(value)) %>% drop_na()

dez5 <- dez5 %>% mutate(value = as.numeric(value)) %>% drop_na()

dez6 <- dez6 %>% mutate(value = as.numeric(value)) %>% drop_na()
...
tab_long <- tab_long %>% as_tibble() %>% mutate(dezena = as_factor(dezena))
